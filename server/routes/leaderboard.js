...
r.get("/", authRequired, (req, res) => {
  const data = db.get()
  const richest = [...data.users].sort((a, b) => b.balance - a.balance).slice(0, 20).map(u => ({ username: u.username, balance: u.balance }))
